...
class pr_object:
    ...
    def __init__(self, pr_filename, settings_filename):
        ...
        try:
            ...
            self.output.write("Cannot convert file.  It may be an outdated PR version.  \
        ...
        self.pr_type_text = self.get_text(self.globalpage.getElementsByTagName('title')[0])
        self.pr_version_text = self.get_text(self.globalpage.getElementsByTagName('custom:date')[0])
        ...
        for sheet in sheet_list:
            ...
            if sheet_name == "Senior Rater Info":
                ...
                for row in sheet_rows:
                    ...
                    self.SR_dict[self.get_text(cells[1])] = (self.get_text(cells[0]), \
            ...
            try:
                ...
                if spell_item == 'Y':
                    ...
                    for line in lines:
                        ...
                        if spelling_result:
                            line_out = "\n" + check_dict[item][0] + " " + "line %d" %line_count + ":\n"
                    ...
                    for line in on_form_dict[item].splitlines():
                        for pattern in self.catch_list:
                            ...
                            if match:
                                ...
                                if options.verbose:
                                    self.output.write('Catch Common => %s [OK]\n' % pattern)
                        line_number += 1
    ...
    def clean_up(self): 
        ...
        self.pdfout_file = '%s%s%s.pdf' % (os.path.split(self.pr_filename)[0], os.path.sep, \
...
class splash_image:
    ...
    def __init__(self):
        ...
        self.dimensions = (self.gif.width(), self.gif.height() + 30, self.centerx, self.centery)
